...
export const PLAYLIST_ORDER_VALUES = PLAYLIST_ORDER_OPTIONS.map((o) => o.value) as [
  PlaylistOrder,
  ...PlaylistOrder[],
]
...
export const PLAYLIST_TIME_UNIT_VALUES = PLAYLIST_TIME_UNIT_OPTIONS.map((o) => o.value) as [
  PlaylistTimeUnit,
  ...PlaylistTimeUnit[],
]

export const PLAYLIST_MODE_OPTIONS = [{ label: 'Timer', value: 'timer' }] as const
export type PlaylistMode = (typeof PLAYLIST_MODE_OPTIONS)[number]['value']
export const PLAYLIST_MODE_VALUES = PLAYLIST_MODE_OPTIONS.map((o) => o.value) as [
  PlaylistMode,
  ...PlaylistMode[],
]
