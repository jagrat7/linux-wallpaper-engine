  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button
          type="button"
          className="border-input h-7 w-12 cursor-pointer rounded border"
        ...
        <div className="flex gap-1">
          {SWATCHES.map((hex) => (
            <button
              ...
              className="border-input aspect-square min-w-0 flex-1 cursor-pointer rounded-full border transition-transform hover:scale-110"
