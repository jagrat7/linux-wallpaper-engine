    ...
    return [
      {
        ...
        options: {
          ignoreInputs: false,
          meta: { name: search.label, description: search.description },
        },
      },
      ...
      ...NAVIGATION_SHORTCUTS.map(([id, to]) => ({
        ...
        options: {
          ignoreInputs: false,
          meta: {
            name: KEYBOARD_SHORTCUTS[id].label,
            description: KEYBOARD_SHORTCUTS[id].description,
          },
        },
      })),
      {
        ...
        options: {
          ignoreInputs: true,
          meta: {
            name: KEYBOARD_SHORTCUTS.help.label,
    ...
    <Dialog open={helpOpen} onOpenChange={setHelpOpen}>
      <DialogTrigger asChild>
        <Button
          ...
          className="text-muted-foreground mb-2 w-full justify-start"
        >
      ...
      <DialogContent className="max-h-[min(42rem,85vh)] overflow-y-auto sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Navigate, search, and manage wallpapers without leaving the keyboard.
          </DialogDescription>
        </DialogHeader>
