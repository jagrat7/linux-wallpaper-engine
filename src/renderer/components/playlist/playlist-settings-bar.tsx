...
export function PlaylistSettingsBar({
  form,
  selectedCount,
  serverError,
  onClearServerError,
}: PlaylistSettingsBarProps) {
  ...
  return (
    <div
      className={cn('border-border bg-card flex items-start gap-6 rounded-xl border p-5', glass)}
    >
      {/* Name */}
      <form.Field
        name="name"
              ...
              return (
                <div className="flex min-w-0 flex-col gap-1.5">
                  <Input
                    ...
                    className="scrollbar-styled h-9 w-16"
                  />
        ...
        children={(field) => {
          ...
          const activeCount = ENGINE_OVERRIDE_FIELDS.filter(
            (f) =>
              ...
              overrides[f.key] !== engineFieldDefault(f, settings),
          ).length
          ...
          const updateOverride = <K extends keyof WallpaperOverrides>(
            key: K,
            value: WallpaperOverrides[K],
          ) => {
            ...
            <div className="space-y-1.5">
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    <span className="truncate">{activeCount > 0 ? 'Custom' : 'Default'}</span>
        ...
        children={(field) => {
          ...
          return (
            <div className="space-y-1.5">
              ...
              <div
                className={cn(
                  'bg-secondary/20 text-muted-foreground flex h-9 items-center gap-2 rounded-md border border-transparent px-3 text-sm',
