import type { DiscoverSectionConfig } from '../../main/services/workshop/workshop'
...
export const DEFAULT_FAVORITE_DISCOVER_SECTION_IDS = PINNED_DISCOVER_SECTION_CONFIGS.map(
  (sectionConfig) => sectionConfig.id,
)
