 ...
 */
export const isFlatpak = (): boolean => !!process.env.FLATPAK_ID || fs.existsSync('/.flatpak-info')
 ...
 */
export const hostExecAsync = (command: string): Promise<{ stdout: string; stderr: string }> => {
